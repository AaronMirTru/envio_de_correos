...
datos_contratos = pd.read_csv(r"C:\\Users\Aaron\Documents\\proyects\\proyecto correo envios\data\dashb_entity_customers.csv", delimiter=';')
...
datos_motivos = pd.read_csv(r"C:\\Users\Aaron\Documents\\proyects\\proyecto correo envios\data\solicitudes_de_alta-14102024_085412.csv", delimiter=';', encoding='UTF-16 LE')
datos_motivos = datos_motivos.dropna(subset=['Motivo Rechazo ATR'])
...
for index, row in bajas.iterrows():
    ...
    tabla_de_bajas.loc[x,'motivo'] = row['Motivo Rechazo ATR']
    # tabla_de_bajas.loc[x,'motivo'] = 'None'
